    ...
    <div className="p-6 bg-gradient-to-br from-[#f7f6f3] to-[#f1f1ef] border border-[#e9e9e7] rounded-lg">
      <div className="flex justify-between items-start mb-3">
        <div className="flex-1">
          ...
          <p className="text-sm text-[#787774]">{currentStepData?.description}</p>
        </div>
        <div className="flex items-center gap-2 text-sm text-[#787774] bg-white px-3 py-1 rounded-full border border-[#e9e9e7] ml-4">
      ...
      {currentStepData?.subSteps && (
        <div className="ml-4 space-y-1.5 mb-4">
